...
class LocalAiAssistant:
    ...
    def _build_prompt(
        ...
        *,
        ...
        return (
            "Eres un analista senior de oportunidades freelance para una firma de automatizacion, scraping y backend.\n"
            ...
            "Reglas:\n"
            "- summary: maximo 280 caracteres, en espanol.\n"
            "- suggested_reply: maximo 420 caracteres, en espanol, escrito como respuesta directa del freelancer; no des consejos al usuario.\n"
            "- sector: una sola categoria.\n"
            "- stack: arreglo de hasta 6 tecnologias.\n"
            "- fit_label: strong_fit, possible_fit, weak_fit o avoid.\n"
            "- recommended_action: apply_now, review_today, clarify_scope o skip.\n"
            "- recommended_state: usa un estado valido del pipeline.\n"
            "- confidence: entero 0-100.\n"
            "- score_delta: entero entre -20 y 20.\n"
            "- missing_info: una sola frase corta.\n"
