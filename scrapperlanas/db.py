...
SQLITE_SCHEMA_STATEMENTS = (
    ...
    """,
    "CREATE INDEX IF NOT EXISTS idx_quality_rule_versions_source ON quality_rule_versions(source_key, version_number DESC)",
    "CREATE INDEX IF NOT EXISTS idx_quality_rule_versions_active ON quality_rule_versions(source_key, is_active)",
    """
